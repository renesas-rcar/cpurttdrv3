...
static drvCPURTT_ProductId_t g_ProductId = DRV_CPURTT_PRODUCT_V4M_7;
...
/* Function used for identifying V4M variants and setting for CPU core */
static uint32_t drvCPURTT_ProductInit(void)
{
    ...
    static const drvRTT_CpuCoreState_t drvCPURTT_V4M7_V4M5_CpuMap[DRV_CPURTTKER_CLUSTERNUM_MAX][DRV_CPURTTKER_CLUSTERNUM_CPUMAX] = {
        {
            DRV_RTTKER_CPU_CORE_ENABLE, 
            DRV_RTTKER_CPU_CORE_ENABLE,
            DRV_RTTKER_CPU_CORE_ENABLE,
            DRV_RTTKER_CPU_CORE_ENABLE
        }
    ...
    static const drvRTT_CpuCoreState_t drvCPURTT_V4M3_V4M2_CpuMap[DRV_CPURTTKER_CLUSTERNUM_MAX][DRV_CPURTTKER_CLUSTERNUM_CPUMAX] = {
        {
            DRV_RTTKER_CPU_CORE_ENABLE, 
            DRV_RTTKER_CPU_CORE_ENABLE,
            DRV_RTTKER_CPU_CORE_ENABLE, 
    ...
    static const uint32_t drvCPURTTKER_V4M7_V4M5_InterruptCpuA1[DRV_CPURTTKER_CPUNUM_MAX] = {
        DRV_CPURTTKER_CPUNUM_CPU1,      /* target interrupt cpu at CA760 for V4M-7, V4M-5 */
        DRV_CPURTTKER_CPUNUM_CPU0,      /* target interrupt cpu at CA761 for V4M-7, V4M-5 */
        DRV_CPURTTKER_CPUNUM_CPU3,      /* target interrupt cpu at CA762 for V4M-7, V4M-5 */
        DRV_CPURTTKER_CPUNUM_CPU2       /* target interrupt cpu at CA763 for V4M-7, V4M-5 */
    };

    static const uint32_t drvCPURTTKER_V4M3_V4M2_InterruptCpuA1[DRV_CPURTTKER_CPUNUM_MAX] = {
        DRV_CPURTTKER_CPUNUM_CPU1,      /* target interrupt cpu at CA760 for V4M-3, V4M-2 */
        DRV_CPURTTKER_CPUNUM_CPU0,      /* target interrupt cpu at CA761 for V4M-3, V4M-2 */
        DRV_CPURTTKER_CPUNUM_CPU0,      /* target interrupt cpu at CA762 for V4M-3, V4M-2 */
        DRV_CPURTTKER_CPUNUM_INVALID    /* target interrupt cpu at CA763 for V4M-3, V4M-2 */
    };
    ...
    if (0 == ret)
    {
        ...
        {
            case DRV_RTTKER_PRODUCT_V4M_7:
                g_ProductId = DRV_CPURTT_PRODUCT_V4M_7;
                (void)memcpy(g_CpuCoreMap, drvCPURTT_V4M7_V4M5_CpuMap, sizeof(drvCPURTT_V4M7_V4M5_CpuMap));
                (void)memcpy(drvCPURTTKER_InterruptCpuA1, drvCPURTTKER_V4M7_V4M5_InterruptCpuA1, sizeof(drvCPURTTKER_V4M7_V4M5_InterruptCpuA1));
                break;

            case DRV_RTTKER_PRODUCT_V4M_5:
                g_ProductId = DRV_CPURTT_PRODUCT_V4M_5;
                (void)memcpy(g_CpuCoreMap, drvCPURTT_V4M7_V4M5_CpuMap, sizeof(drvCPURTT_V4M7_V4M5_CpuMap));
                (void)memcpy(drvCPURTTKER_InterruptCpuA1, drvCPURTTKER_V4M7_V4M5_InterruptCpuA1, sizeof(drvCPURTTKER_V4M7_V4M5_InterruptCpuA1));
                break;

            case DRV_RTTKER_PRODUCT_V4M_3:
                g_ProductId = DRV_CPURTT_PRODUCT_V4M_3;
                (void)memcpy(g_CpuCoreMap, drvCPURTT_V4M3_V4M2_CpuMap, sizeof(drvCPURTT_V4M3_V4M2_CpuMap));
                (void)memcpy(drvCPURTTKER_InterruptCpuA1, drvCPURTTKER_V4M3_V4M2_InterruptCpuA1, sizeof(drvCPURTTKER_V4M3_V4M2_InterruptCpuA1));
                break;

            case DRV_RTTKER_PRODUCT_V4M_2:
                g_ProductId = DRV_CPURTT_PRODUCT_V4M_2;
                (void)memcpy(g_CpuCoreMap, drvCPURTT_V4M3_V4M2_CpuMap, sizeof(drvCPURTT_V4M3_V4M2_CpuMap));
                (void)memcpy(drvCPURTTKER_InterruptCpuA1, drvCPURTTKER_V4M3_V4M2_InterruptCpuA1, sizeof(drvCPURTTKER_V4M3_V4M2_InterruptCpuA1));
                break;
    ...
    {
        {
            ...
            DRV_CPURTTKER_APMU_CORE_BASE + DRV_CPURTTKER_CLUSTER_CORE_OFFSET,
            DRV_CPURTTKER_APMU_CORE_BASE + DRV_CPURTTKER_CLUSTER_OFFSET,
            DRV_CPURTTKER_APMU_CORE_BASE + DRV_CPURTTKER_CLUSTER_OFFSET + DRV_CPURTTKER_CLUSTER_CORE_OFFSET
        }
    };
    ...
    for (i = 0; i < (uint32_t) DRV_CPURTTKER_CLUSTERNUM_MAX; i++)
    {
        for (j = 0; j < (uint32_t) DRV_CPURTTKER_CLUSTERNUM_CPUMAX; j++)
        {
            if (DRV_RTTKER_CPU_CORE_ENABLE == g_CpuCoreMap[i][j])
            {
                ...
                {
                    PwrctrlcBaseAddress = RegBasePwrctrlcTable[i][j];
...
static int CpurttDrv_init(void)
{
    ...
    /* identify V4M variants and setting for CPU core */
