...
#define DRV_RTTKER_FBA_RGID    0x2ULL
...
#define DRV_RTTKER_FBA_RGID    0x0ULL
...
/* RTTEX REG */
#define DRV_RTTKER_ISP0_RTTEX   (0xFEAC1000U | ((DRV_RTTKER_FBA_RGID & 0xFULL) << 36ULL))
#define DRV_RTTKER_ISP1_RTTEX   (0xFEAC2000U | ((DRV_RTTKER_FBA_RGID & 0xFULL) << 36ULL))
#define DRV_RTTKER_IMR0_RTTEX   (0xFE601000U | ((DRV_RTTKER_FBA_RGID & 0xFULL) << 36ULL))
#define DRV_RTTKER_IMR1_RTTEX   (0xFE602000U | ((DRV_RTTKER_FBA_RGID & 0xFULL) << 36ULL))
#define DRV_RTTKER_IMR2_RTTEX   (0xFE603000U | ((DRV_RTTKER_FBA_RGID & 0xFULL) << 36ULL))
#define DRV_RTTKER_IMS0_RTTEX   (0xFE605000U | ((DRV_RTTKER_FBA_RGID & 0xFULL) << 36ULL))
#define DRV_RTTKER_IMS1_RTTEX   (0xFE606000U | ((DRV_RTTKER_FBA_RGID & 0xFULL) << 36ULL))
#define DRV_RTTKER_IMP0_RTTEX   (0xFF8C0000U | ((DRV_RTTKER_FBA_RGID & 0xFULL) << 36ULL))
#define DRV_RTTKER_IMP1_RTTEX   (0xFF8C1000U | ((DRV_RTTKER_FBA_RGID & 0xFULL) << 36ULL))
#define DRV_RTTKER_IMP2_RTTEX   (0xFF8C2000U | ((DRV_RTTKER_FBA_RGID & 0xFULL) << 36ULL))
#define DRV_RTTKER_IMP3_RTTEX   (0xFF8C3000U | ((DRV_RTTKER_FBA_RGID & 0xFULL) << 36ULL))
#define DRV_RTTKER_OCV0_RTTEX   (0xFF8C4000U | ((DRV_RTTKER_FBA_RGID & 0xFULL) << 36ULL))
#define DRV_RTTKER_OCV1_RTTEX   (0xFF8C5000U | ((DRV_RTTKER_FBA_RGID & 0xFULL) << 36ULL))
#define DRV_RTTKER_OCV2_RTTEX   (0xFF8C6000U | ((DRV_RTTKER_FBA_RGID & 0xFULL) << 36ULL))
#define DRV_RTTKER_OCV3_RTTEX   (0xFF8C7000U | ((DRV_RTTKER_FBA_RGID & 0xFULL) << 36ULL))
#define DRV_RTTKER_DP0_RTTEX    (0xFFF56000U | ((DRV_RTTKER_FBA_RGID & 0xFULL) << 36ULL))
#define DRV_RTTKER_DP1_RTTEX    (0xFFF57000U | ((DRV_RTTKER_FBA_RGID & 0xFULL) << 36ULL))
#define DRV_RTTKER_CNN_RTTEX    (0xFFF50000U | ((DRV_RTTKER_FBA_RGID & 0xFULL) << 36ULL))
#define DRV_RTTKER_DSP0_RTTEX   (0xFFF64000U | ((DRV_RTTKER_FBA_RGID & 0xFULL) << 36ULL))
#define DRV_RTTKER_DSP1_RTTEX   (0xFFF65000U | ((DRV_RTTKER_FBA_RGID & 0xFULL) << 36ULL))
#define DRV_RTTKER_DSP2_RTTEX   (0xFFF66000U | ((DRV_RTTKER_FBA_RGID & 0xFULL) << 36ULL))
#define DRV_RTTKER_DSP3_RTTEX   (0xFFF67000U | ((DRV_RTTKER_FBA_RGID & 0xFULL) << 36ULL))
#define DRV_RTTKER_CNRAM_RTTEX  (0xFFF55000U | ((DRV_RTTKER_FBA_RGID & 0xFULL) << 36ULL))
#define DRV_RTTKER_SLIM0_RTTEX  (0xFF8F4000U | ((DRV_RTTKER_FBA_RGID & 0xFULL) << 36ULL))
#define DRV_RTTKER_SLIM1_RTTEX  (0xFF8F5000U | ((DRV_RTTKER_FBA_RGID & 0xFULL) << 36ULL))
#define DRV_RTTKER_CA76D0_RTTEX (0xFF870000U | ((DRV_RTTKER_FBA_RGID & 0xFULL) << 36ULL))
#define DRV_RTTKER_CA760_RTTEX  (0xFF871000U | ((DRV_RTTKER_FBA_RGID & 0xFULL) << 36ULL))
#define DRV_RTTKER_CA761_RTTEX  (0xFF872000U | ((DRV_RTTKER_FBA_RGID & 0xFULL) << 36ULL))
#define DRV_RTTKER_CA76D1_RTTEX (0xFF873000U | ((DRV_RTTKER_FBA_RGID & 0xFULL) << 36ULL))
#define DRV_RTTKER_CA762_RTTEX  (0xFF874000U | ((DRV_RTTKER_FBA_RGID & 0xFULL) << 36ULL))
#define DRV_RTTKER_CA763_RTTEX  (0xFF875000U | ((DRV_RTTKER_FBA_RGID & 0xFULL) << 36ULL))
#define DRV_RTTKER_UMFL0_RTTEX  (0xE7B61000U | ((DRV_RTTKER_FBA_RGID & 0xFULL) << 36ULL))
#define DRV_RTTKER_SMPS0_RTTEX  (0xE7B64000U | ((DRV_RTTKER_FBA_RGID & 0xFULL) << 36ULL))
#define DRV_RTTKER_SMPO0_RTTEX  (0xE7B63000U | ((DRV_RTTKER_FBA_RGID & 0xFULL) << 36ULL))
#define DRV_RTTKER_PAP_RTTEX    (0xE7B62000U | ((DRV_RTTKER_FBA_RGID & 0xFULL) << 36ULL))
